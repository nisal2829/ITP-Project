...
import { signInFailure, signInStart, signInSuccess } from '../../redux/nisal/User/userSlice';
import OAuth from '../../components/nisal/OAuth';
...
export default function SignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/nisal/auth/signin', {
        method: 'POST',
        headers: {
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
        ...
        <div className="text-center mt-6">
          <p className="text-gray-600">
            ...
            <Link to="/Nsign-up" className="text-blue-600 hover:underline">
              Sign Up
            </Link>
          </p>
          {error && (
