import User from "../../models/hiruni/user.model.js";
import Item from "../../models/hiruni/item.model.js";
import bcryptjs from "bcryptjs";
import { errorHandler } from "../../utils/hiruni/error.js";
...
export const store = async (req, res, next) => {
  const { userId, namee, type, quentity, status, profilePicture } = req.body;
